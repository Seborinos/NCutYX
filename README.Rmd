...
The code below computes clusters using the MuNCut measure. With `model = FALSE` the raw data Y and Z are used. If `model = TRUE`, the predictions Y and Z are used instead of Y and Z, respectively.
```{r eval=FALSE}
clust <- muncut(Z,
                Y,
                X,
